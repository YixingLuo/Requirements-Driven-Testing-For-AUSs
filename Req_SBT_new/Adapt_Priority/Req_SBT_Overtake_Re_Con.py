...
# data_folder = os.getcwd() + '/Overtake_Datalog_Re_' + str(time.strftime("%Y_%m_%d_%H"))
# if not os.path.exists(data_folder):
#     os.mkdir(data_folder)

data_folder = "/gpfs/share/home/1801111354/Req_SBT_new2/Adapt_Priority/Overtake_Datalog_Re_2021_01_09_19"
...
if __name__ == '__main__':
    ...
    pattern_count = numpy.loadtxt(target_dir + "/pattern_count_3.txt")
    evaluation = list(numpy.loadtxt(target_dir + "/evaluations_3.txt"))
    searched_violation_pattern = list(numpy.loadtxt(target_dir + "/searched_violation_pattern_3.txt"))
    violation_pattern_ranking_removed = []
    variables = list(numpy.loadtxt(target_dir + "/variables_3.txt"))
    sorted_pop = []
    ...
    population = 50
    search_round = 50
    vars_file_name = "/gpfs/share/home/1801111354/Req_SBT_new2/Adapt_Priority/Overtake_Datalog_Re_2021_01_09_19/2021_01_10_Adapt_Priority_variable_3"
    results_file_name = "/gpfs/share/home/1801111354/Req_SBT_new2/Adapt_Priority/Overtake_Datalog_Re_2021_01_09_19/2021_01_10_Adapt_Priority_results_3"
