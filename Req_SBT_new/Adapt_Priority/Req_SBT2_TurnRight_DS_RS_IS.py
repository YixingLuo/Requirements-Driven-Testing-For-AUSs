...
data_folder = os.getcwd() + '/TurnRight_Datalog_Req2_DS_RS_IS_' + str(time.strftime("%Y_%m_%d_%H"))
...
if __name__ == '__main__':
    ...
    while total_second > 0:
        ...
        if round_index == 0:
            ...
            Configuration = TurnRightConfigure(goal_selection_flag, population, 50, round_index, target_dir)
            ...
            Configuration = TurnRightConfigure(goal_selection_flag, population, search_second, round_index, target_dir)
            vars_file_name = Configuration.file_dir_var
            results_file_name = Configuration.file_dir_eval
