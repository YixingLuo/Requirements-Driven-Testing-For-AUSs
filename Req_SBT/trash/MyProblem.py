...
class MyProblem(ea.Problem):  # 继承Problem父类
    ...
    def aimFunc(self, pop):  # 目标函数
        ...
        # result = create_run_scenario_overtake (Vars, self.config, self.file_dir_sce, self.file_dir_data, self.file_dir_eval)
        # pop.ObjV = result
        ...
        # args = (Vars, self.config, self.file_dir_sce, self.file_dir_data, self.file_dir_eval)
